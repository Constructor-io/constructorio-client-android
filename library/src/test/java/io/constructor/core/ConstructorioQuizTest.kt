...
class ConstructorioQuizTest {
    ...
    fun getQuizNextQuestion() {
        ...
        val path = "/v1/quizzes/test-quiz/next?key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.43.0&_dt="
    ...
    fun getQuizNextQuestionWithVersionId() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/next?quiz_version_id=11db5ac7-67e1-4000-9000-414d8425cab3&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.43.0&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizNextQuestionWithSessionId() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/next?quiz_session_id=31f6bdae-6f1d-482f-b37f-f7a9e346973a&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.43.0&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizNextQuestionWithSection() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/next?section=Products&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.43.0&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizNextQuestionWithAnswers() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/next?a=1&a=2%2C3&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.43.0&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizResults() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/results?a=1&a=2%2C3&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.43.0&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizResultsWithVersionId() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/results?a=1&a=2%2C3&quiz_version_id=11db5ac7-67e1-4000-9000-414d8425cab3&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.43.0&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizResultsWithSessionId() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/results?a=1&a=2%2C3&quiz_session_id=31f6bdae-6f1d-482f-b37f-f7a9e346973a&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.43.0&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizResultsWithSection() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/results?section=Products&a=1&a=2%2C3&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.43.0&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizResultsWithPagination() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/results?page=2&num_results_per_page=30&a=1&a=2%2C3&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.43.0&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizResultsWithFilters() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/results?filters%5BBrand%5D=XYZ&filters%5BBrand%5D=123&filters%5Bgroup_id%5D=123&a=1&a=2%2C3&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.43.0&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizNextQuestionUsingBuilder() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/next?a=1&a=2%2C3&quiz_version_id=11db5ac7-67e1-4000-9000-414d8425cab3&section=Products&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.43.0&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizResultsUsingBuilder() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/results?section=Products&a=1&a=2%2C3&quiz_version_id=11db5ac7-67e1-4000-9000-414d8425cab3&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.43.0&_dt="
        assert(request.path!!.startsWith(path))
    }
}