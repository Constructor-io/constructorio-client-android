...
class ConstructorioQuizTest {
    ...
    fun getQuizNextQuestion() {
        ...
        val path = "/v1/quizzes/test-quiz/next?key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.19.4&_dt="
    ...
    fun getQuizNextQuestionWithVersionId() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/next?version_id=11db5ac7-67e1-4000-9000-414d8425cab3&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.19.4&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizNextQuestionWithSection() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/next?section=Products&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.19.4&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizNextQuestionWithAnswers() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/next?a=1&a=2%2C3&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.19.4&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizResults() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/finalize?a=1&a=2%2C3&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.19.4&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizResultsWithVersionId() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/finalize?a=1&a=2%2C3&version_id=11db5ac7-67e1-4000-9000-414d8425cab3&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.19.4&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizResultsWithSection() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/finalize?a=1&a=2%2C3&section=Products&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.19.4&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizNextQuestionUsingBuilder() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/next?a=1&a=2%2C3&version_id=11db5ac7-67e1-4000-9000-414d8425cab3&section=Products&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.19.4&_dt="
        assert(request.path!!.startsWith(path))
    }
    ...
    fun getQuizResultsUsingBuilder() {
        ...
        val request = mockServer.takeRequest()
        val path = "/v1/quizzes/test-quiz/finalize?a=1&a=2%2C3&version_id=11db5ac7-67e1-4000-9000-414d8425cab3&section=Products&key=golden-key&i=guido-the-guid&ui=player-one&s=79&c=cioand-2.19.4&_dt="
        assert(request.path!!.startsWith(path))
    }
}