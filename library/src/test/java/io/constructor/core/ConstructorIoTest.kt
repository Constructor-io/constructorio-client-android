...
class ConstructorIoTest {
    ...
    fun verifySessionStartUrl() {
        val expected = "https://ac.cnstrc.com/behavior?c=${BuildConfig.CLIENT_VERSION}&s=1&action=session_start&autocomplete_key=testKey&_dt=1520000000000"
        val urlBuilder = HttpUrl.Builder().scheme("https")
                .host("ac.cnstrc.com")
    ...
    fun verifySearchClickThroughEvent() {
        val expected = "https://ac.cnstrc.com/autocomplete/term/click_through?c=${BuildConfig.CLIENT_VERSION}&s=1&autocomplete_section=Products&autocomplete_key=testKey&_dt=1520000000000"
        val urlBuilder = HttpUrl.Builder().scheme("https")
                .host("ac.cnstrc.com")
                .addPathSegment("autocomplete")
                .addPathSegment("term")
    ...
    fun verifySearchLoadedEventUrl() {
        val expected = "https://ac.cnstrc.com/behavior?c=${BuildConfig.CLIENT_VERSION}&s=1&action=search-results&autocomplete_key=testKey&_dt=1520000000000"
        val urlBuilder = HttpUrl.Builder().scheme("https")
                .host("ac.cnstrc.com")
                .addPathSegment("behavior")
                .addQueryParameter(Constants.QueryConstants.CLIENT, BuildConfig.CLIENT_VERSION)
    ...
    fun verifyInputFocusEvent() {
        val expected = "https://ac.cnstrc.com/behavior?c=${BuildConfig.CLIENT_VERSION}&i=user_id&s=1&action=focus&autocomplete_key=testKey&_dt=1520000000000"
        val urlBuilder = HttpUrl.Builder().scheme("https")
                .host("ac.cnstrc.com")
                .addPathSegment("behavior")
                .addQueryParameter(Constants.QueryConstants.CLIENT, BuildConfig.CLIENT_VERSION)
