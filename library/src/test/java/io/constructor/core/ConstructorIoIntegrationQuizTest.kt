...
class ConstructorIoIntegrationQuizTest {
    ...
    fun getQuizResultsAgainstRealResponse() {
        ...
        val quizResult = observer.values()[0].get()
        assertNotNull(quizResult?.versionId)
        assertEquals(quizResult?.result?.resultsUrl, "https://ac.cnstrc.com/browse/items?key=ZqXaOfXuBWD4s3XzCI1q&num_results_per_page=10&collection_filter_expression=%7B%22or%22%3A%5B%7B%22and%22%3A%5B%7B%22name%22%3A%22group_id%22%2C%22value%22%3A%22BrandX%22%7D%2C%7B%22name%22%3A%22Color%22%2C%22value%22%3A%22Blue%22%7D%5D%7D%2C%7B%22and%22%3A%5B%7B%22name%22%3A%22group_id%22%2C%22value%22%3A%22BrandX%22%7D%2C%7B%22name%22%3A%22Color%22%2C%22value%22%3A%22red%22%7D%5D%7D%5D%7D&i=wacko-the-guid&c=cioand-2.19.5&ui=player-three&s=67")
